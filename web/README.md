...
```bash
yarn add -D typescript @types/react @types/node && touch tsconfig.json
```

Add MaterialUI from design system and svg icons.
...
- Server vercel for deployment integrate with github.
